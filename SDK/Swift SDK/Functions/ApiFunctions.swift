...
//      builder.append(SCBCodePageType.Blank);  builder.append("*Blank*\n" .data(using: String.Encoding.ascii))
    ...
    static func createTopMarginData(_ modelIndex: ModelIndex?, _ emulation: StarIoExtEmulation) -> Data {
...
//      rect = CGRect(x: 0, y: 0, width: width,  height: height)
    ...
    static func createLabelData(_ emulation: StarIoExtEmulation, type: SCBLabelType) -> Data {
        let otherData: Data = "Hello World.\n".data(using: String.Encoding.ascii)!
...
//      builder.append(SCBLabelType.invalid)
