...
#include <StarIO/PreventingNameConflicts.h>
...
typedef struct StarPrinterStatus_2_
{
    ...
    // printer status 11
    UCHAR      drawer1OpenedMethod;
    SM_BOOLEAN drawer1OpenCloseSignal;
    UCHAR      drawer2OpenedMethod;
    SM_BOOLEAN drawer2OpenCloseSignal;
    
    // printer status 13
    SM_BOOLEAN externalDevice1Connected;
    SM_BOOLEAN externalDevice2Connected;
    
    // printer status 14
    SM_BOOLEAN partsReplacementNotification;
    SM_BOOLEAN cleaningNotification;
    UCHAR      detectedPaperWidth;
